...
- **GIF 支持**：支持 GIF 格式遮罩。
- **悬浮球**：在绑定应用中显示悬浮球，点击可切换当前组配置；回到桌面自动隐藏。
...
#### 悬浮球使用
- 勾选“设置 → 启用悬浮球”后，在已绑定的应用内会显示悬浮球。
- 点击悬浮球可弹出配置列表，快速切换该组内的配置；支持手动销毁。
- 退出到桌面时，悬浮球会自动隐藏；避免在桌面上遮挡。
...
### 7) GIF 动图遮罩
- 在“快速使用”或“预设”中选择 GIF 文件即可作为遮罩；无需额外设置。
- GIF 会保持原始播放效果；透明度由全局设置统一生效。
